 ...
 * @author chris
 */
public class Vehiculo implements Comparable<Vehiculo> { //Le damos a que implemente el método
    ...
    @Override //Este método compareTo, compara el objeto actual(this) de la clase vehículo con el vehículo(v) pasado por parámetro
    public int compareTo(Vehiculo v) { 
        return this.matricula.compareTo(v.getMatricula()); //Si devuelve 0, significa que ambas matrículas son iguales
    }
    
    @Override
    public String toString() {
        return "Vehiculo{" + "marca=" + marca + ", matricula=" + matricula + ", numKM=" + numKilometros + ", descripcion=" + descripcion + ", precio=" + precio;
    }
