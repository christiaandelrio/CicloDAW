...
public class Concesionario {
    ...
    public void listaVehiculos(){
        ...
        if(numVehiculos == 0){  //* Corrección, añadí aquí un if else para que si el concesionario está vacío muestre un error     
            System.out.println("Error: El concesionario está vacío");
        }else{    
            for (int i = 0; i < numVehiculos; i++) {
